...
if (isset($_GET['action'])) {
	if ($_GET['action'] == 'start') {
		shell_exec("python3 " . PATH_APPLICATION . "/outstreamer.py > /dev/null 2> " . PATH_LOG . "/outstreamer.log &");
...
$process = shell_exec("ps -aux | grep 'python3 " . PATH_APPLICATION . "/outstreamer.py'");
